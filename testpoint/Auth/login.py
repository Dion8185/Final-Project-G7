...
def register_teacher():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            """
            cursor.execute(query_insert_user, (teacher_id, email, hashed_password))

            query_insert_teacher = """
                INSERT INTO teachers (teacher_id, email, firstname, middlename, lastname, region, province, city, barangay)
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s);
            """
            cursor.execute(query_insert_teacher, (teacher_id, email, firstname, middlename, lastname, region, province, city, barangay))
